package md.utm.spam.ui.component
...
import md.utm.spam.mailbox.viewmodel.EmailSort
import md.utm.spam.mailbox.viewmodel.icon
import md.utm.spam.mailbox.viewmodel.title
    ...
    TopAppBar(
        ...
        actions = {
            ...
            DropdownMenu(
                ...
                EmailSort.entries.forEach { sort ->
                    DropdownMenuItem(
                        text = { Text(sort.title) },
                        leadingIcon = { Icon(sort.icon, null) },
